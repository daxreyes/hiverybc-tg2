# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in myproj.
...
base_config[
    "templating.kajiki.strip_text"
] = False  # Change this in setup.py too for i18n to work.
...
base_config.model = myproj.model
base_config.DBSession = myproj.model.DBSession
# Configure the authentication backend
base_config.auth_backend = "ming"
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "a1d9302d-49b5-4f42-8a9a-6d6effcc1bf6"
